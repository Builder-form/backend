...
Найди среди текста полей text и всех полей answer строительные термины и дай им определения на английском языке в виде\n
data:\n
[{\n
    "termin": "название термина",\n
    "description":"описание термина"\n
}, ...далее другие термины]\n
Ответь мне только json текстом, твой ответ должно быть возможно сделать содержимым json файла, определения на английском языке. Никакого текста больше писать ненужно.\n
